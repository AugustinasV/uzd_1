...
int main(){
    ...
    for (int i=0;i < grupe.size(); i++) {
        if (grupe[i].galutinis_paz < 5) {
            file1<<grupe[i].vardas<<" "<< grupe[i].pavarde<< " ";
            for (int u=0; u<grupe[i].nd_paz.size(); u++) {
                file1 << grupe[i].nd_paz[u] << " ";
            }
        }
        else {
            file2<<grupe[i].vardas<<" "<< grupe[i].pavarde<< " ";
            for (int u=0; u<grupe[i].nd_paz.size(); u++) {
                file2 << grupe[i].nd_paz[u] << " ";
            }
        }
    }
    file1.close();
